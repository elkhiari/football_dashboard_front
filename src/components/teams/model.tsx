...
function ModelTeams({ setActive, getTeams}:{ setActive : any, getTeams: any}) {
    ...
    const addTeam = async(e : any) => {
        ...
        if (!data.name || !data.logo || !data.league) {
  ...
  return (
    <div className='w-full flex place-content-center place-items-center min-h-screen  backdrop-blur-sm p-2 fixed top-0 left-0'>
        <form className='w-full md:min-w-[300px] bg-white shadow rounded p-4' onSubmit={addTeam}>
            ...
            <div className='p-2'>
                <input name='name' type="text" placeholder="Team name" className='outline-none border border-gray-300 rounded p-2 w-full' />
            </div>
            <div className='p-2'>
                <input name='logo' type="text" placeholder="Team logo" className='outline-none border border-gray-300 rounded p-2 w-full' />
            </div>
            <div className='p-2'>
